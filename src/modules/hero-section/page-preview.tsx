      ...
      >
        <div className="flex justify-between items-center mb-4 md:mb-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs md:text-sm font-medium text-foreground/90">Nossa História</span>
          </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-3">
          {['/images/couple-preview/1.jpg', '/images/couple-preview/2.jpg', '/images/couple-preview/3.jpg'].map((photoSrc, index) => (
            <motion.div 
              key={photoSrc}
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-xs md:text-sm font-medium text-white/80">Nosso aniversário</h3>
              <p className="text-[8px] md:text-xs text-white/60">15 de outubro</p>
            </div>
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-[8px] md:text-[10px] text-white/60">Perfect - Ed Sheeran</p>
          </div>
