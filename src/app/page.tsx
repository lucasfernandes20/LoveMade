  ...
  return (
    <div>
      <main className="mx-auto">
        <section className="min-h-[calc(100svh-6rem)]">
          <div className="container  flex flex-col my-20 md:my-0 md:grid md:grid-cols-[2.5fr_1.5fr] gap-10 items-center">
            <div>
              ...
              <p className="text-base text-center md:text-start md:text-lg font-medium my-10">
                Crie um{" "}
                <span className="text-secondary">QR Code exclusivo</span> que,
                ao ser escaneado, revela uma página personalizada com a foto do
                casal e o <span className="text-secondary">grande pedido</span>
              </p>
              <Link
                href="/create"
                className={cn(
